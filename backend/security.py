...
if SECRET_KEY is None:
    raise Exception("SECRET KEY could not be loaded. Did you forget to add an '.env' file?")
ALGORITHM = "HS256"
...
def verify_hash(plain_text: str, hashed_text: str) -> bool:
    ...
    return bcrypt.checkpw(password = password_byte_enc , hashed_password = hashed_byte_encoding)
